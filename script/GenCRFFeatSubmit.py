...
CRFBins = "../../../learning/libcrfsuite-0.12.so,../../../learning/liblbfgs-1.10.so,../../../learning/libcqdb-0.12.so,../../../learning/crfsuite"
featIndex = {}
featList = []
totalFeat = 0
...
def GenJobDescription(test, keep, f, total, testFolds):
    ...
    f.write("transfer_input_files = ../input.tar.gz, ../../script/crf_feat_test.py, ../{0}/fs{1}.txt,{2}\n".format(args.featdir, test, CRFBins))
